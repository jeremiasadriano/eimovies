...
public class UpcomingAdpater extends RecyclerView.Adapter<UpcomingAdpater.SimilarHolder> {
    private Context context;
    private List<FilmeResponse> filmes;
    private static ItemFilmeClickListener itemFilmeClickListener;

    public UpcomingAdpater(ItemFilmeClickListener itemFilmeClickListener) {
        this.itemFilmeClickListener = itemFilmeClickListener;
    }

    public UpcomingAdpater(Context context, List<FilmeResponse> filmes) {
    ...
    public SimilarHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SimilarHolder(LayoutInflater.from(this.context).inflate(R.layout.item_upcoming_rv, parent, false));
    }
    ...
    public static class SimilarHolder extends RecyclerView.ViewHolder {
        ...
        public SimilarHolder(@NonNull View itemView) {
            super(itemView);
            images = itemView.findViewById(R.id.up_poster);
            title = itemView.findViewById(R.id.up_title);
            rating = itemView.findViewById(R.id.up_rate);
            realiseYear = itemView.findViewById(R.id.up_year);
            genre = itemView.findViewById(R.id.up_genre);
