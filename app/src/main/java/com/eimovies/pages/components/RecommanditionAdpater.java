...
public class RecommanditionAdpater extends RecyclerView.Adapter<RecommanditionAdpater.SimilarHolder> {
    private Context context;
    private List<FilmeResponse> filmes;
    private static ItemFilmeClickListener itemFilmeClickListener;

    public RecommanditionAdpater(ItemFilmeClickListener itemFilmeClickListener) {
        this.itemFilmeClickListener = itemFilmeClickListener;
    }

    public RecommanditionAdpater(Context context, List<FilmeResponse> filmes) {
    ...
    public SimilarHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SimilarHolder(LayoutInflater.from(this.context).inflate(R.layout.items_recommandition_movie_rv, parent, false));
    }
    ...
    public static class SimilarHolder extends RecyclerView.ViewHolder {
        ...
        public SimilarHolder(@NonNull View itemView) {
            super(itemView);
            images = itemView.findViewById(R.id.recommendationImg);
