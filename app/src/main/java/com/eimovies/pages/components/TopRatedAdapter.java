...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.SimilarHolder> {
    private Context context;
    private List<FilmeResponse> filmes;
    private static ItemFilmeClickListener itemFilmeClickListener;

    public TopRatedAdapter(ItemFilmeClickListener itemFilmeClickListener) {
        this.itemFilmeClickListener = itemFilmeClickListener;
    }

    public TopRatedAdapter(Context context, List<FilmeResponse> filmes) {
    ...
    public SimilarHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SimilarHolder(LayoutInflater.from(this.context).inflate(R.layout.item_top_rated_rv, parent, false));
    }
    ...
    public static class SimilarHolder extends RecyclerView.ViewHolder {
        ...
        public SimilarHolder(@NonNull View itemView) {
            super(itemView);
            images = itemView.findViewById(R.id.top_poster);
            title = itemView.findViewById(R.id.top_title);
            rating = itemView.findViewById(R.id.top_rate);
            realiseYear = itemView.findViewById(R.id.top_year);
            genre = itemView.findViewById(R.id.top_genre);
