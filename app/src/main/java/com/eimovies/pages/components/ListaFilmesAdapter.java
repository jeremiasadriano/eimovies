...
public class ListaFilmesAdapter extends RecyclerView.Adapter<ListaFilmesAdapter.SimilarHolder> {
    ...
    public ListaFilmesAdapter(Context context, List<FilmeResponse> filmes) {
    ...
    public SimilarHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SimilarHolder(LayoutInflater.from(this.context).inflate(R.layout.item_listar_filme_rv, parent, false));
    }
    ...
    public static class SimilarHolder extends RecyclerView.ViewHolder {
        ...
        public SimilarHolder(@NonNull View itemView) {
            super(itemView);
            images = itemView.findViewById(R.id.image_poster_filme);
